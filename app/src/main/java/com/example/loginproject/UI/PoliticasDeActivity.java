...
import android.os.Bundle; // Para manejar la instancia de Bundle en onCreate.
import android.widget.TextView; // Para usar TextView en la actividad.
...
public class PoliticasDeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Corregir la cadena de texto de las políticas
